...
class PriceSparkline extends StatelessWidget {
  ...
  factory PriceSparkline(List<AmmoPrice> prices, {bool touchMode = false}) {
    ...
    return PriceSparkline._internal(
      seriesList, animate: false, first: first, last: last,
    );
  }

  PriceSparkline._internal(this._seriesList, {this.animate, this.first, this.last});


    @override
  Widget build(BuildContext context) {
      return Tooltip(
        message: "Red segments indicate data generated by the Gunbroker Rule.",
